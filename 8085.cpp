    ...
    while(!f.eof())
    {
        ...
        switch(index)
        {
                 ...
                 case 1: {
                    ...
                    if(ch1!=' ')
                    {
                        cout<<"1 Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                    f.get(ch1);
                    f.get(value,5,'H');
            ...
            case 2:
                {
                    ...
                    if(ch1!=' ')
                    {
                        cout<<"2 Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                    f.get(value,6,'H');
                    val = charToInt(value);
            ...
            case 3:
                {
                    ...
                    if(ch1!=' ')
                    {
                        cout<<"3a Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                    f.get(ch1);
                    if(ch1=='S') //For SP
                    ...
                    if(ch2!=',')
                    {
                        cout<<"3b Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                    f.get(value1,3);
                    f.get(value2,3,'H');
                    ...
                    else if(ch1=='D')
                    {
                        ...
                        cout<<"3c Syntax Error in line "<<linenum-1;
                    break;
                }
            case 4:
                {
                    ...
                    if(ch2!=' ')
                    {
                        cout<<"4a Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                    f.get(ch2);
                    f.get(ch1);
                    if(ch1!=',')
                    {
                        cout<<"4b Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                    f.get(ch1);
                    int temp;
            ...
            case 5:
                {
                    ...
                    if(ch1!=' ')
                    {
                        cout<<"5a Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                    f.get(ch1);
                    if(ch1=='H')
                    ...
                    else if(ch1=='D')
                    {
                        ...
                        cout<<"5b Syntax Error in line "<<linenum-1;
                        break;
                }
            case 6: f.get(ch1); //ADD
                    if(ch1!=' ')
                    {
                        cout<<"6 Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                    f.get(ch1);
                    int te1;
            ...
            case 7: f.get(ch1); //STA
                    if(ch1!=' ')
                    {
                        cout<<"7 Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                    f.get(value,6,'H');
                    val = charToInt(value);
            ...
            case 8: if(flags[0]!=true) //JNZ
                    {
                        ...
                        if(ch1!=' ')
                        {
                            cout<<"8 Syntax Error in line "<<linenum-1;
                            exit(0);
                        }
                        getline(f,tag1,'\n');
                        linenum = mymap[tag1];
            ...
            case 9: f.get(ch1); //CMP
                    if(ch1!=' ')
                    {
                        cout<<"9 Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                    f.get(ch1);
                    int te;
            ...
            case 10: if(flags[1]!=true) //JNC
                     {
                        ...
                        if(ch1!=' ')
                        {
                            cout<<"10 Syntax Error in line "<<linenum-1;
                            exit(0);
                        }
                        getline(f,tag1,'\n');
                        linenum = mymap[tag1];
            ...
            case 11: f.get(ch1); //MVI
                     if(ch1!=' ')
                    {
                        cout<<"11 Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                     f.get(ch1);
                     f.get(value,6,'H');
            ...
            case 12: if(flags[0]==true) //JZ
                     {
                        ...
                        if(ch1!=' ')
                        {
                            cout<<"12 Syntax Error in line "<<linenum-1;
                            exit(0);
                        }
                        getline(f,tag1,'\n');
                        linenum = mymap[tag1];
            ...
            case 13: f.get(ch1); //DCR
                     if(ch1!=' ')
                    {
                        cout<<"13 Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                     f.get(ch1);
                     int te2;
            ...
            case 15: f.get(ch1); //INR
                     if(ch1!=' ')
                    {
                        cout<<"15 Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                     f.get(ch1);
                     te2 = getRegVal(ch1);
            ...
            case 16: f.get(ch1); //DCX
                    if(ch1!=' ')
                    {
                        cout<<"16a Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                    f.get(ch1);
                    if(ch1=='H')
                    ...
                    else if(ch1=='D')
                    {
                        ...
                        cout<<"16b Syntax Error in line "<<linenum-1;
                        break;
            case 17: f.get(ch1); //PUSH
                     if(ch1!=' ')
                    {
                        cout<<"17a Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                     f.get(ch1);
                     if(ch1=='H')
            ...
            case 18: f.get(ch1); //POP
                     if(ch1!=' ')
                    {
                        cout<<"18 Syntax Error in line "<<linenum-1;
                        exit(0);
                    }
                     f.get(ch1);
            ...
            case 21: if(flags[1]==true) //JC
                     {
                        ...
                        if(ch1!=' ')
                        {
                            cout<<"21 Syntax Error in line "<<linenum-1;
                            exit(0);
                        }
                        getline(f,tag1,'\n');
                        linenum = mymap[tag1];
            ...
            default: cout<<"default Syntax Error in line "<<linenum-1;
                     exit(0);
        }//end of switch
        f.get(ch3);
        while(ch3!='\n')
